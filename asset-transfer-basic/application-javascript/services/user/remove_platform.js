...
const removePlatform = async(req, res, next) => {
    ...
    const idPlatform = req.body.platform_id;
		const assocIdUser = req.body.assoc_user_id;
    ...
    try {
        ...
        const contract = network.getContract(chaincodeName);
				...
				console.log('\n--> Submit Transaction: removePlatform, removes platform from a user');
    ...
    //}
        ...
        console.log('Platform removal failed with error: '+error);

				if (error.toString().includes('not registered')) {
