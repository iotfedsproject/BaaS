...
const getProductInfo = async(req, res, next) => {
    ...
    try {
        ...
        let result = await contract.evaluateTransaction('GetProduct', product_id);
    ...
    //}
        ...
        console.log('Get product information failed with error: '+error);

        res.status(403).send('Get product information failed: '+error)
