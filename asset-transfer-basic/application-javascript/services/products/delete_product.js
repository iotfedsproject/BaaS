...
const deleteProduct = async(req, res, next) => {
    ...
    try {
        ...
        console.log('\n--> Submit Transaction: DeleteProduct, deletes a product and returns the deleted product');
        let result = await contract.submitTransaction('DeleteProduct', product_id, user_id);
    ...
    //}
        ...
        console.log('Delete product failed with error: '+error);

        res.status(403).send('Delete product creation failed: '+error)
