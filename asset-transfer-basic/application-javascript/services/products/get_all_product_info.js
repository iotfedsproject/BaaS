...
const getAllProductInfo = async(req, res, next) => {
    ...
    try {
        ...
        let result = await contract.evaluateTransaction('GetAllAssetsOfType', "Product");
    ...
    //}
        ...
        console.log('Get all products information failed with error: '+error);

        res.status(403).send('Get all products information failed: '+error)
