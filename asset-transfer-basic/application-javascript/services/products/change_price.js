...
const changePrice = async(req, res, next) => {
    ...
    try {
        ...
        console.log('\n--> Submit Transaction: ChangePrice is called when someone wants to change the price of a product');
        let result = await contract.submitTransaction('ChangePrice', product_id, new_price);
    ...
    //}
        ...
        console.log('Changing the price of a product failed with error: '+error);

        res.status(403).send('Changing the price of a product failed: '+error)
