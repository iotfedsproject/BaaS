...
const getAllExchangableTokens = async(req, res, next) => {
    ...
    try {
        ...
        console.log('\n--> Submit Transaction: GetAllExchangableTokens, retrieves all products with their details');
        let result = await contract.evaluateTransaction('GetAllExchangableTokens');
    ...
    //}
        ...
        console.log('Get all exchangable tokens failed with error: '+error);

        res.status(403).send('Get all exchangable tokens failed: '+error)


    }

}
module.exports = getAllExchangableTokens;
