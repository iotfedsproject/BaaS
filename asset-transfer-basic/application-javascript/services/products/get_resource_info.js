...
const getResourceInfo = async(req, res, next) => {
    ...
    try {
        ...
        let result = await contract.evaluateTransaction('GetResource', resource_id);
    ...
    //}
        ...
        console.log('Get resource information failed with error: '+error);

        res.status(403).send('Get resource information failed: '+error)


    }

}
module.exports = getResourceInfo;
