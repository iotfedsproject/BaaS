...
const updateReps = async(req, res, next) => {
    ...
    try {
        ...
        console.log('\n--> Submit Transaction: UpdateAllReputations, updates all reputations in BaaS');
        await contract.submitTransaction('UpdateAllReputations');
    ...
    //}
        ...
        res.status(403).send('Update failed: '+error)


    }

}
module.exports = updateReps;
